enum Opcodes: Byte {
    ...
    LD_HLmei ham_B = 0x70; // Load B into (HL) memory
...
/**
    ...
    static constexpr Byte JP_a16 = 0xC3; // Jump to absolute address
    // 0xD3 & 0xE3 are unused
    static constexpr Byte DI = 0xF3; // Disable interrupts

    // x4 opcodes
    static constexpr Byte INC_B = 0x04; // Increment B
    static constexpr Byte INC_D = 0x14; // Increment D
    static constexpr Byte INC_H = 0x24; // Increment H
    static constexpr Byte INC_HLmem = 0x34; // Increment (HL) memory
    static constexpr Byte LD_B_H = 0x44; // Load H into B
    static constexpr Byte LD_D_H = 0x54; // Load H into D
    static constexpr Byte LD_H_H = 0x64; // Load H into H
    static constexpr Byte LD_HLmem_H = 0x74; // Load H into (HL) memory
    static constexpr Byte ADD_A_H = 0x84; // Add H to A
    static constexpr Byte SUB_H = 0x94; // Subtract H from A
    static constexpr Byte AND_H = 0xA4; // Logical AND H with A
    static constexpr Byte OR_H = 0xB4; // Logical OR H with A
    static constexpr Byte CALL_NZ_A16 = 0xC4; // Call subroutine at absolute address if Z flag is not set
    static constexpr Byte CALL_NC_A16 = 0xD4; // Call subroutine at absolute address if C flag is not set
    // 0xE4 and 0xF4 are unused

    // x5 opcodes
    static constexpr Byte DEC_B = 0x05; // Decrement B
    static constexpr Byte DEC_D = 0x15; // Decrement D
    static constexpr Byte DEC_H = 0x25; // Decrement H
    static constexpr Byte DEC_HLmem = 0x35; // Decrement (HL) memory
    static constexpr Byte LD_B_L = 0x45; // Load L into B
    static constexpr Byte LD_D_L = 0x55; // Load L into D
    static constexpr Byte LD_H_L = 0x65; // Load L into H
    static constexpr Byte LD_HLmem_L = 0x75; // Load L into (HL) memory
    static constexpr Byte ADD_A_L = 0x85; // Add L to A
    static constexpr Byte SUB_L = 0x95; // Subtract L from A
    static constexpr Byte AND_L = 0xA5; // Logical AND L with A
    static constexpr Byte OR_L = 0xB5; // Logical OR L with A
    static constexpr Byte PUSH_BC = 0xC5; // Push BC onto stack
    static constexpr Byte PUSH_DE = 0xD5; // Push DE onto stack
    static constexpr Byte PUSH_HL = 0xE5; // Push HL onto stack
    static constexpr Byte PUSH_AF = 0xF5; // Push AF onto stack

    // x6 opcodes
    static constexpr Byte LD_B_d8 = 0x06; // Load 8-bit immediate into B
    static constexpr Byte LD_D_d8 = 0x16; // Load 8-bit immediate into D
    static constexpr Byte LD_H_d8 = 0x26; // Load 8-bit immediate into H
    static constexpr Byte LD_HLmem_d8 = 0x36; // Load 8-bit immediate into (HL) memory
    static constexpr Byte LD_B_HLmem = 0x46; // Load (HL) memory into B
    static constexpr Byte LD_D_HLmem = 0x56; // Load (HL) memory into D
    static constexpr Byte LD_H_HLmem = 0x66;
    static constexpr Byte HALT = 0x76; // Halt CPU until interrupt occurs
    static constexpr Byte ADD_A_HLmem = 0x86; // Add (HL) memory to A
    static constexpr Byte SUB_HLmem = 0x96; // Subtract (HL) memory from A
    static constexpr Byte AND_HLmem = 0xA6; // Logical AND (HL) memory with A
    static constexpr Byte OR_HLmem = 0xB6; // Logical OR (HL) memory with A
    static constexpr Byte ADD_A_d8 = 0xC6; // Add 8-bit immediate to A
    static constexpr Byte SUB_d8 = 0xD6; // Subtract 8-bit immediate from A
    static constexpr Byte AND_d8 = 0xE6; // Logical AND 8-bit immediate with A
    static constexpr Byte OR_d8 = 0xF6; // Logical OR 8-bit immediate with A
