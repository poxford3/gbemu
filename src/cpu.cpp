...
void Cpu::runProgram(Mem &memory) {
    ...
    while (1) {
        ...
        executeInstructions(cycles, opcode, memory);
    }
};
...
void Cpu::executeInstructions(uint cycles, Byte opcode, Mem &memory) {
    ...
    switch (opcode) {
        ...
        case 0xCB: {
            ...
            executeExtendedOpcode(cycles, cbOpcode, memory);
            break;
        }
        case EI: {
            _EI();
...
void Cpu::executeExtendedOpcode(uint &cycles, Byte opcode, Mem &memory) {
    switch (opcode) {
        // x0 extended opcodes
        case RLC_B: {
            rotateLeft(B, false);
